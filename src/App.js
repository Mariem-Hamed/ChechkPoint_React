          ...
          <div className="form-items">
            ...
            <div className="col-md-12 mt-3">
              ...
              <input
                ...
                required
              />
              <label className="btn btn-sm btn-outline-secondary" for="male">
                Male
              </label>
              ...
              <input
                ...
                required
              />
              <label className="btn btn-sm btn-outline-secondary" for="female">
                Female
              </label>
              <input
                type="radio"
                ...
                required
              />
              <label className="btn btn-sm btn-outline-secondary" for="secret">
                Secret
              </label>
